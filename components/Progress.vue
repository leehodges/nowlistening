...
svg.progress {
  ...
  right: 0;
  bottom: 0;
  filter: drop-shadow(0 0 3px rgb(110, 255, 77)) drop-shadow(0 0 2px rgba(0, 207, 255)) drop-shadow(0 0 3px rgba(255, 102, 143, 1)) drop-shadow(0 0 5px rgba(255, 225, 94)) opacity(65%) contrast(150%);
}
